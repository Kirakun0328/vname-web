...
translations["en"]["収集元：VTuber Database・VTuber Post・ユーザーローカル・AIVナビ。個人勢や小規模な活動者も対象です。掲載・活動状況の反映には遅れや漏れがあり、全員を網羅するものではありません。収録件数にはグループやチャンネルが含まれる場合があります。"]="Sources: VTuber Database, VTuber Post, User Local and AIV Navi. Independent and small creators are included. Listings and activity status may be delayed or incomplete; coverage is not exhaustive. Counts may include groups and channels.";
translations["zh"]["収集元：VTuber Database・VTuber Post・ユーザーローカル・AIVナビ。個人勢や小規模な活動者も対象です。掲載・活動状況の反映には遅れや漏れがあり、全員を網羅するものではありません。収録件数にはグループやチャンネルが含まれる場合があります。"]="来源：VTuber Database、VTuber Post、User Local、AIV Navi。收录范围包括个人势和小规模活动者。收录与活动状态的更新可能延迟或遗漏，并非涵盖所有人。条数可能包含团体和频道。";
translations["ko"]["収集元：VTuber Database・VTuber Post・ユーザーローカル・AIVナビ。個人勢や小規模な活動者も対象です。掲載・活動状況の反映には遅れや漏れがあり、全員を網羅するものではありません。収録件数にはグループやチャンネルが含まれる場合があります。"]="출처: VTuber Database, VTuber Post, User Local, AIV Navi. 개인 및 소규모 활동자도 대상입니다. 수록 및 활동 상태 반영에 지연이나 누락이 있을 수 있으며, 모든 활동자를 망라하지는 않습니다. 건수에는 그룹이나 채널이 포함될 수 있습니다.";
