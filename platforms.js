...
window.VNamePlatforms = (() => {
  ...
  function account(value) {
    ...
    const patterns={youtube:/^\/(?:channel\/UC[\w-]{22}|@[\w.\-]+)\/?$/,tiktok:/^\/@[\w.\-]+(?:\/live)?\/?$/,twitch:/^\/[\w]+\/?$/,avvy:/^\/u\/[0-9a-hjkmnp-tv-z]{26}\/?$/,iriam:/^\/s\/user\/[^/]+\/?$/,reality:/^\/profile\/[^/]+\/?$/,'17live':/^\/(?:s\/u|(?:[a-z]{2}\/)?profile(?:\/[ur])?)\/[^/]+\/?$/,showroom:/^\/(?:r\/)?[\w-]+\/?$/,twitcasting:/^\/[\w:.-]+\/?$/,niconico:/^\/(?:user\/\d+|community\/co\d+)\/?$/,mirrativ:/^\/user\/\d+\/?$/,bilibili:/^\/\d+\/?$/,spoon:/^\/(?:[a-z]{2}\/)?(?:profile\/[^/]+|channel\/\d+(?:\/tab\/home)?)\/?$/,kick:/^\/[\w-]+\/?$/,soop:/^\/[\w-]+\/?$/,topia:/^\/(?:p\/)?[\w-]+\/?$/,palmu:/^\/users\/[^/]+\/?$/,mixch:/^\/u\/\d+\/?$/,bigo:/^\/[\w-]+\/?$/,acfun:/^\/u\/\d+\/?$/,whowatch:/^\/(?:sp\/)?profile\/w:[\w.-]+\/?$/,pococha:/^\/app\/users\/[\w-]+\/?$/,pikapika:/^\/index\/roomuser\/uid\/\d+\/?$/,standfm:/^\/channels\/[a-f0-9]{24}\/?$/,radiotalk:/^\/program\/\d+\/?$/,openrec:/^\/(?:m\/)?user\/[\w-]+\/?$/,pokekara:/^\/user\/\d+\/?$/,instagram:/^\/[\w.]+\/?$/,facebook:/^\/[\w.]+\/?$/,chzzk:/^\/[a-f0-9]{32}\/?$/,rplay:/^\/(?:c\/[\w.-]+|creatorhome\/[a-f0-9]{24})\/?$/};
    ...
    if(platform==='whowatch')u.pathname=u.pathname.replace(/^\/sp\//,'/');
